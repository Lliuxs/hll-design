...
export function Avatar(props) {
    ...
    var avatarFigure = useMemo(function () {
        ...
        if (isLoading) {
            ...
            avatarFigure = (React.createElement("img", { src: src, alt: username, "data-testid": "avatar-img" }));
        }
        else {
    ...
    return (React.createElement(Image, __assign({ size: size, isLoading: isLoading, src: src }, props, { "data-testid": "avatar-div" }), avatarFigure));
}
Avatar.defaultProps = {
    isLoading: false,
    username: "loading",
